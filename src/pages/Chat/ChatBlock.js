...
const Chat = () => {
  ...
  const searchFunction = (e) => {
    ...
    messages && setMessages(messages.filter((message) => {
      if (search == "") {
        return message
      } else if (
                  ...
                  <Card className="chatMarginBottom">
                    <div className="p-4 border-bottom help-desk-header">
                      <Row>
                        ...
                        <Col md="1" xs="1">
                          <BsThreeDotsVertical
                            className="chat-search__icons threeDots"
                    ...
                    {dotDrop ? <> <div className="dotDropdown">
                        ...
                        <div className="dropdownElement blocked" onClick={() => {
                            setDotDrop(false)
                        }}>
                            Delete
                        </div>
                      ...
                      <div className="chat__leftSection">
                        ...
                        <div className="chat__filters">
                          <ButtonGroupS variant="contained" color="primary" aria-label="contained primary button group" className="buttons__groups">
                            ...
                            <ButtonS className="buttons__group active" onClick={() => history.push("/inbox/block")}>Blocked</ButtonS>
                          </ButtonGroupS>
                        </div>
                            ...
                            >
                              <div className="block__cards">
                                            <div className="block__card">
                                                <img src="https://st3.depositphotos.com/1007566/13129/v/1600/depositphotos_131295836-stock-illustration-businessman-character-avatar-icon.jpg" alt="Avatar" className="avatar chatInbox__avatar"></img>
                                                <p className="rightSection__name">William</p>
                                            </div>
                                            <div className="block__card">
                                                <img src="https://st3.depositphotos.com/1007566/13129/v/1600/depositphotos_131295836-stock-illustration-businessman-character-avatar-icon.jpg" alt="Avatar" className="avatar chatInbox__avatar"></img>
                                                <p className="rightSection__name">William</p>
                                  ...
                                  <ul className="list-inline mb-0">
                                    <li className="list-inline-item">
                                      ...
                                      <Link onClick={onImageClick}>
                                        <FaCamera className="mdi mdi-file-image-outline attachments" id="Imagetooltip" />
