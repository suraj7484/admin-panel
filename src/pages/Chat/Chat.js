...
const Chat = () => {
  ...
  // document.querySelectorAll("dropModal").forEach((item) => {
  //   item.classList.add("dropdown__menu__active")
  // })
  // document.querySelectorAll("dropModal").classList.add("dropdown__menu__active")

  // const body = document.body
  // body.addEventListener("click", function () {

  //   const ele = document.querySelectorAll("dropdown__menu__active")

  //   // if (ele.classList.contains("dropdown__menu__active")) {
  //   //   document.getElementsByClassName("dropModal").classList.remove("dropdown__menu__active")
  //   // } else {
  //   //   // document.getElementsByClassName("dropdown").classList.add("dropdown__menu__active")
  //   //   console.log("hello")
  //   // }
  //   // const el = [1, 2, 2, 2, 5, 2]
  ...
  //   if (ele.length > 0) {
  //     console.log(ele.id)
  //     // ele.classList.remove("dropdown__menu__active")
  //   }

  //   // document.getElementsByClassName("dropdown").classList.remove("dropdown__menu__active")
  //   console.log(ele)
  // })
                      ...
                      <div className="chat__leftSection">
                        ...
                        <div className="chat__filters">
                          <ButtonGroupS variant="contained" color="primary" aria-label="contained primary button group" className="buttons__groups">
                            <ButtonS className="buttons__group active" onClick={() => history.push("/inbox")}>All</ButtonS>
                            ...
                            <ButtonS className="buttons__group" onClick={() => history.push("/inbox/achieved")}>Achieved</ButtonS>
                            ...
                            >
                              {messagesInbox &&
                                map(messagesInbox, (message, index) => (
                                  ...
                                  >
                                    <input type="checkbox" className="chatInbox__checkbox" />
                                          ...
                                          <div className="chatInbox__right">
                                            <div className="chatInbox__rightTop">
                                              <div className="conversation-name">
                                                {message.sender} {message.unread == 0 ? "" : `( ${message.unread} )`}
                                              </div>
                                              <div className="time">
                                            ...
                                            <p className="chat-time mb-0 bottomStar">
                                              {star ? <AiFillStar onClick={() => setStar(false)} /> : <AiOutlineStar onClick={() => setStar(true)} />}
                                            </p>
                                          </div>
                                        </div>
                                              ...
                                              <p className="chat-time mb-0">
                                                <div className="bottomRow">
                                                  ...
                                                  <div className="time">
                                                    ...
                                                    <BiCheckDouble style={{ color: "skyblue", fontSize: "1.2rem", marginLeft: "6px" }} />
                                                  </div>
                                                </div>
                                              </p>
                                            </div>
                            ...
                            <Col>
                              <div className="position-relative" >
                                ...
                                <input
                                  ...
                                  className="form-control chat-input chatInput__main"
